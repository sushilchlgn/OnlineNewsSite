                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('product.store')}}" method="POST"
                                            ...
                                            <input type="text" id="code" name="code" placeholder="Enter Code/Sku:" class="form-control mb-2">
                                            ...
                                            <input type="text" id="tax" name="tax" placeholder="Enter Product Tax:" class="form-control mb-2">
